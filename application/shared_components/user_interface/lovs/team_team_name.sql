prompt --application/shared_components/user_interface/lovs/team_team_name
begin
--   Manifest
--     TEAM.TEAM_NAME
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(120315585843623989878)
,p_lov_name=>'TEAM.TEAM_NAME'
,p_source_type=>'TABLE'
,p_location=>'LOCAL'
,p_query_table=>'TEAM'
,p_return_column_name=>'TEAM_ID'
,p_display_column_name=>'TEAM_NAME'
,p_default_sort_column_name=>'TEAM_NAME'
,p_default_sort_direction=>'ASC'
,p_version_scn=>15683750968193
