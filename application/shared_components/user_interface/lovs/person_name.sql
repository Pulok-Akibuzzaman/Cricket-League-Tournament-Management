prompt --application/shared_components/user_interface/lovs/person_name
begin
--   Manifest
--     PERSON.NAME
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(120315585121221989878)
,p_lov_name=>'PERSON.NAME'
,p_source_type=>'TABLE'
,p_location=>'LOCAL'
