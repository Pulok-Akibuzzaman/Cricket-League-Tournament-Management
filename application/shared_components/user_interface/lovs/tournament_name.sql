prompt --application/shared_components/user_interface/lovs/tournament_name
begin
--   Manifest
--     TOURNAMENT.NAME
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(120315606497089990446)
,p_lov_name=>'TOURNAMENT.NAME'
,p_source_type=>'TABLE'
,p_location=>'LOCAL'
,p_query_table=>'TOURNAMENT'
,p_return_column_name=>'TOURNAMENT_ID'
,p_display_column_name=>'NAME'
,p_default_sort_column_name=>'NAME'
,p_default_sort_direction=>'ASC'
,p_version_scn=>15683750997138
