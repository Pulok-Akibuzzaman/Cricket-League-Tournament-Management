...
wwv_flow_imp_page.create_page(
 p_id=>56
,p_name=>'Players Whose Contract Salary Is the Maximum in Their Team'
,p_alias=>'PLAYERS-WHOSE-CONTRACT-SALARY-IS-THE-MAXIMUM-IN-THEIR-TEAM'
,p_step_title=>'Players Whose Contract Salary Is the Maximum in Their Team'
...
,p_last_updated_on=>wwv_flow_imp.dz('20251217185319Z')
,p_created_by=>'AURNA'
,p_last_updated_by=>'AURNA'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(121278426037475066801)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(121278426704134066803)
,p_name=>'Players Whose Contract Salary Is the Maximum in Their Team'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(121278427122213066805)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(121278427579085066806)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(121278427976018066806)
,p_query_column_id=>3
